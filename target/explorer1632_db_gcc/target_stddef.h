...
/*
 *		t_stddef.hのターゲット依存部（Explorer16/32 Development Board用）
 *
 ...
 *  ターゲットを識別するためのマクロの定義
 */
#define TOPPERS_EXPLORER1632			/* システム略称 */
...
#include <stdint.h>
typedef signed int			intptr_t;	/* ポインタを格納できる符号付き整数 */
 ...
 *  プロセッサで共通な定義
 */
#include "pic24f_gcc/prc_stddef.h"
