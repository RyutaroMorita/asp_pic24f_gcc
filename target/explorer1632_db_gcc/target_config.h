...
/*
 *		ターゲット依存モジュール（Explorer 16/32 DB用）
 *
...
#define DEFAULT_ISTK		(void *)(0x00008000U - DEFAULT_ISTKSZ)
 ...
 *  割込み要求のクリア
 */
extern void x_clear_int(INTNO intno);
 ...
 *  割込み要求のチェック
 */
extern  bool_t x_probe_int(INTNO intno);
 ...
 */
#include "pic24f_gcc/prc_config.h"
